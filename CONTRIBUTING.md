...
1. [Submit a bug](https://bugs.launchpad.net/charm-vsphere-integrator/+filebug) to explain the need for and track the change.
...
See [this page](https://github.com/charmed-kubernetes/kubernetes-docs/blob/master/pages/k8s/charm-vsphere-integrator.md)
